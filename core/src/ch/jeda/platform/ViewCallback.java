...
public interface ViewCallback {
    ...
    void postPointerDown(Object source, int pointerId, EnumSet<Button> pressedButtons, float x, float y);

    void postPointerMoved(Object source, int pointerId, EnumSet<Button> pressedButtons, float x, float y);
